					...
					<div >
						<div className=' mx-auto contactUs '>
							<div className=''>
								{/* <!-- Title --> */}
								<div className=''>
									<h1 className='block font-semibold text-black dark:text-white text-2xl md:text-3xl lg:text-4xl text-center title'>
										Contactos
								...
								<div className='footer-container'>
									...
									<div>
										...
										<Link style={{display:'flex' , gap:'5px',alignItems:'center' }} to="https://www.facebook.com/andalucian.muslims/?locale=ar_AR">
										<img width='35px' height='35px' src={facebook} alt="" />
											<span style={{color:'blue'}}>FaceBook</span></Link>

										<Link style={{display:'flex' , gap:'5px',alignItems:'center' }} to="https://www.youtube.com/channel/UClGwaKsiXdBfVm611gZgzpw"><img width='35px' height='35px' src={youtube} alt="" />
											<span style={{color:'blue'}}>Youtube</span></Link>
									</div>
